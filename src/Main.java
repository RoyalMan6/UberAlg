...
/* private static void testLinkedList() {
	...
	Map<String,Integer> b1= new BST<String,Integer>() ; 
	 b1.insert("d",4) ;
	...
	/* private static void testBST(){
		BST<String,Integer> b1 = new BST<String,Integer>() ;
		 ...
		 b1.inorder();
		Pair<Boolean, Integer> res = b1.remove("a") ;
	...
	/* private static void testLocococo() {
		...
		locator.add("B", new Location(6, 3));
			...
			Pair<Boolean,Integer> r = locator.remove("r", new Location(6,1)) ;
			System.out.println(r.first);
			System.out.println(r.second);
		
	} */
	
	/*private static void testLocatorMappppp() {
		LocatorMap<String> Mapp = new TreeLocatorMap<String>() ;
		Pair<Boolean, Integer> what = Mapp.add("F", new Location(6,7)) ;
		System.out.println(what.first);
		what = Mapp.add("F", new Location(6,7)) ;
